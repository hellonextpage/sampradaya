...
.site-content>.container>.products-area>.row{
    width:1380px;
    margin:0px;
}
.site-content>.container>.group-banners>.row{
    width:1380px;
    margin:0px;
}
.products-content>.container-fuild>.container{
   margin: 5px;
}
.products-content>.container-fuild>.container>.products-area>.row{
  width:1380px;
    margin:0px;
}
.products-content>.container-fuild>.container>.products-area>.heading{
    margin-left:15px;
}
.products-content>.container-fuild>.container>.group-banners>.row{
  width:1380px;
    margin:0px;
}
...
<section class="blog-content hideClass">
<div class="container">
    <div class="blog-area">
        <!-- heading -->
        <div class="heading">
